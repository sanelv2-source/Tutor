...
export default function TeacherDashboardDemo({ onNavigate, variant = 'landing' }: TeacherDashboardDemoProps) {
  ...
  return (
    <section className={isLanding
      ? 'py-12 sm:py-24 bg-slate-50 border-y border-slate-200 overflow-hidden'
      ...
      <div className={isLanding ? 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8' : ''}>
        <div className={isLanding
          ? 'grid lg:grid-cols-[0.82fr_1.18fr] gap-8 lg:gap-14 items-center'
          ...
          <div className="relative min-w-0">
            <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-slate-950 shadow-xl sm:shadow-2xl">
