    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
      <main className="pb-16 sm:pb-24">
        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-[1.75rem] sm:rounded-[2.5rem] shadow-xl sm:shadow-2xl border border-slate-100 p-6 sm:p-10 relative overflow-hidden">
            ...
            <div className="mb-8">
              <span className="text-4xl sm:text-5xl font-extrabold text-slate-900">149,-</span>
            ...
            <button 
              ...
              className="w-full py-4 px-4 text-base sm:text-lg font-bold rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg hover:shadow-xl transition-all"
            >
